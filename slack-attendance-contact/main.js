document.onkeydown = function (e) {
    ...
    function input(text, direction) {
        ...
        if (document.activeElement.nodeName.toLowerCase() != 'div') return
        if (document.activeElement.children == null) return
        if (document.activeElement.children.length == 0) return
        var p = document.activeElement.children[0]
        if (p.nodeName.toLowerCase() != 'p') return
